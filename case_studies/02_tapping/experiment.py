...
# Functions to create tapping stimuli
...
# Create isochronous stimuli with different tempos
tempo_800_ms = [800] * 15  # Slow 
tempo_600_ms = [600] * 12  # Fast 
...
# create nodes for isochronous stimuli
nodes_iso = [
    StaticNode(
        definition={
            "stim_name": name,
...
# create nodes for music stimuli
nodes_music = [
    StaticNode(
        definition={
            "stim_name": name,
...
# Analysis class for processing tapping responses
...
class TapTrialISO(TapTrial):  # For isochronous tapping trials
...
class TapTrialMusic(TapTrial):  # For music tapping trials
    time_estimate = DURATION_ESTIMATED_TRIAL
...
# Define the isochronous tapping task block
ISO_tapping = join(
    InfoPage(
        Markup(
            """
...
# Define the music tapping task block
music_tapping = join(
    InfoPage(
        Markup(
            """
